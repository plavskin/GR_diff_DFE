function [combined_LL, unscaled_gradient_vector, grad_parameter_names] = ...
    LL_calculator_strain_looper_pairwise_multiref_direct(param_vals,...
    ...
    grad_parameter_names = ...
        ...
        strcat(strain_list, '_pp'), strcat(strain_list, '_gr')];
    ...
    for test_strain_idx = 1:test_strain_number
        ...
        test_gr_name = strcat(current_test_strain, '_gr');
        test_petite_prop = parameter_dict(test_pp_name);
        test_mean = parameter_dict(test_gr_name);
        ...
        for ref_strain_idx = 1:ref_strain_number
            ...
            ref_gr_name = strcat(current_ref_strain, '_gr');
            ref_petite_prop = parameter_dict(ref_pp_name);
            ref_mean = parameter_dict(ref_gr_name);
            ...
            if sum(current_data_indices, 1) > 0
                ...
                possible_fitted_parameters = ...
                    {test_pp_name, test_gr_name, ref_pp_name, ref_gr_name};
                ...
                [current_LL, current_gradient_dict] = ...
                    LL_calc_within_pair_fast(test_mean, ref_mean, ...
                ...
                if gradient_specification
                    ...
                    unscaled_gradient_dict_combined(ref_gr_name) = ...
                        nansum([unscaled_gradient_dict_combined(ref_gr_name), ...
                            current_gradient_dict('ref_mean')]);
                    unscaled_gradient_dict_combined(test_gr_name) = ...
                        nansum([unscaled_gradient_dict_combined(test_gr_name), ...
                            current_gradient_dict('test_mean')]);
                end
            end

%            if strcmp(current_ref_strain, 'EP026_2A2C')
%                ref_gr_name
%                current_gradient_dict('ref_mean')
%                unscaled_gradient_dict_combined(ref_gr_name)
%            end
