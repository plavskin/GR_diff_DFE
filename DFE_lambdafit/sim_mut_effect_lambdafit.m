function new_param_values = sim_mut_effect_lambdafit(key_list, value_list)
    ...
    %non_neutral_muts = binornd(total_mut_numbers,(1-prop_neutral_SNM));

    % In lambda_fit regime, assume all mutations are non-neutral
    non_neutral_muts = total_mut_numbers;
