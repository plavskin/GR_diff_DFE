function MLE_strain_pairwise_diff_sep_pet_twopart(key_list, value_list)
    ...
    strain_LL_table_file = fullfile(datafile_path,strcat('current_best_strainlooper_LL-',...
        output_id_parameter,'.csv'));
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % select fraction of data to use in initial run
    initial_data_fraction = 0.005;
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%    ref_strain_list = data_table.ref_Strain;
    ...
    mut_effect_fixed_parameter_array = ...
        combined_fixed_parameter_array((global_param_number+1):...
            (global_param_number+strain_number));
    mut_effect_min_array = ...
        combined_min_array((global_param_number+1):...
            (global_param_number+strain_number));
    mut_effect_max_array = ...
        combined_max_array((global_param_number+1):...
            (global_param_number+strain_number));
    mut_effect_length_array = ...
        combined_length_array((global_param_number+1):...
            (global_param_number+strain_number));
    mut_effect_position_array = ...
        combined_position_array((global_param_number+1):...
            (global_param_number+strain_number));
    mut_effect_start_values = ...
        combined_start_values_array((global_param_number+1):...
            (global_param_number+strain_number));

    petite_prop_fixed_parameter_array = ...
        combined_fixed_parameter_array((global_param_number+strain_number+1):...
            (global_param_number+2*strain_number));
    petite_prop_min_array = ...
        combined_min_array((global_param_number+strain_number+1):...
            (global_param_number+2*strain_number));
    petite_prop_max_array = ...
        combined_max_array((global_param_number+strain_number+1):...
            (global_param_number+2*strain_number));
    petite_prop_length_array = ...
        combined_length_array((global_param_number+strain_number+1):...
            (global_param_number+2*strain_number));
    petite_prop_position_array = ...
        combined_position_array((global_param_number+strain_number+1):...
            (global_param_number+2*strain_number));
    petite_prop_start_values = ...
        combined_start_values_array((global_param_number+strain_number+1):...
            (global_param_number+2*strain_number));
    ...
    mut_effect_profile_lb_array = ...
        combined_profile_lb_array((global_param_number+1):...
            (global_param_number+strain_number));
    mut_effect_profile_ub_array = ...
        combined_profile_ub_array((global_param_number+1):...
            (global_param_number+strain_number));
    petite_prop_profile_lb_array = ...
        combined_profile_lb_array((global_param_number+strain_number+1):...
            (global_param_number+2*strain_number));
    petite_prop_profile_ub_array = ...
        combined_profile_ub_array((global_param_number+strain_number+1):...
            (global_param_number+2*strain_number));

    global_logspace_array = combined_logspace_array(1:global_param_number);
    mut_effect_logspace_array = combined_logspace_array((global_param_number+1):...
            (global_param_number+strain_number));
    petite_prop_logspace_array = combined_logspace_array((global_param_number+strain_number+1):...
            (global_param_number+2*strain_number));
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%    end
    ...
    % if doing mutlistart or global search and one solution didn't converge, replace table_data with NA
