function [c, ceq, c_gradient, ceq_gradient, gradient_key] = ...
            nonlin_constraint_poissonmut(param_vals, input_value_dict, ...
                ~)
    ...
    sqrt_a = sqrt(a);
    c = mu_SNM * effective_lambda_SNM + 4 * sqrt_a - L / 2;
    ...
    if gradient_specification % check that gradient required
        ...
        c_gradient = ...
            [d_c_d_prop_pos_SNM, d_c_d_lambda_SNM, d_c_d_mu_SNM, d_c_d_shape_SNM, d_c_d_prop_neut_SNM];
        gradient_key = {'prop_pos_SNM', 'lambda_SNM', 'mu_SNM', 'shape_SNM', 'prop_neut_SNM'};
